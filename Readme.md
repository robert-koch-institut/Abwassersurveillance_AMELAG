...
Robert Koch-Institut, & Umweltbundesamt. (2026). Abwassersurveillance AMELAG [Data set]. Zenodo. [https://doi.org/10.5281/zenodo.22110730](https://doi.org/10.5281/zenodo.22110730)
<!-- CITATION_END -->
...
Für jeden Standort werden die nicht normalisierten Messwerte (optional können auch die normalisierten Messwerte verwendet werden) für SARS-CoV-2, Influenza A und B-Virus sowie RSV A, RSV B und das gemeinsam gemessene RSV A/B in Genkopien pro Liter (Genkopien/L) angegeben. Zusätzlich werden die Messwerte der logarithmierten Genkopien mittels eines generalisierten additiven Modells (GAM) geglättet und zugehörige Konfidenzintervalle berechnet. 
...
Da mit verschiedenen Kläranlagen und Laboren viele Akteure in die Datenerhebung involviert sind, kann es zu Unregelmäßigkeiten in den Daten der Einzelstandorte kommen, die einen verzerrenden Einfluss auf die über alle Standorte aggregierten Auswertungen haben können. Sobald solche Auffälligkeiten festgestellt werden, werden die entsprechenden Daten der Einzelstandorte bis zur vollständigen Abklärung und Lösung der Ursachen aus den aggregierten Auswertungen und Daten ([`amelag_aggregierte_kurve.tsv`](https://github.com/robert-koch-institut/Abwassersurveillance_AMELAG/blob/main/amelag_aggregierte_kurve.tsv)) ausgeschlossen. Der Zeitraum und der Standort der ausgeschlossenen Werte sind unter [`Kontextmaterialien/Data/amelag_entfernte_standortdaten.tsv`](https://github.com/robert-koch-institut/Abwassersurveillance_AMELAG/blob/main/Kontextmaterialien/Data/amelag_entfernte_standortdaten.tsv) dokumentiert. In den Daten der Einzelstandorte ([`amelag_einzelstandorte.tsv`](https://github.com/robert-koch-institut/Abwassersurveillance_AMELAG/blob/main/amelag_einzelstandorte.tsv)) bleiben die Werte weiterhin enthalten.
...
|:-----------------------|:--------|:------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| standort               | string  | Beispiele:<br>`Aachen`, `Ratzeburg`, `Weil am Rhein`                                                  | Standort der Kläranlage.                                                                                                                                                                                                                                                                |
| bundesland             | string  | Werte:<br>`BB`, `BE`, `BW`, `BY`, `HB`, `HE`, `HH`, …                                                 | Kürzel des Bundeslandes, in dem sich die Kläranlage befindet.                                                                                                                                                                                                                           |
| datum                  | date    | Format:<br>`YYYY-MM-DD`<br>Fehlende Werte:<br>`NA`                                                    | Datum, an dem die 24-Stunden-Mischprobenahme in der Kläranlage begonnen hat.                                                                                                                                                                                                            |
| viruslast              | number  | Werte:<br>`≥0`<br>Fehlende Werte:<br>`NA`                                                             | Gemessene Viruslast (in Genkopien pro Liter).                                                                                                                                                                                                                                           |
| viruslast_normalisiert | number  | Werte:<br>`≥0`<br>Fehlende Werte:<br>`NA`                                                             | Nach dem Durchfluss normalisierte Viruslast (wie in der Variable "viruslast" beschrieben).                                                                                                                                                                                              |
| vorhersage             | number  | Werte:<br>`≥0`<br>Fehlende Werte:<br>`NA`                                                             | Vorhergesagte Viruslast (mittels einer GAM-Regression mit adaptiver Glättung auf Basis der nicht-normalisierten Viruslasten, optimiert mittels Kreuzvalidierung-Kriterium für die 10er-logarithmierten Viruslasten, angegeben ist der auf die Originalskala zurücktransformierte Wert). |
| obere_schranke         | number  | Werte:<br>`≥0`<br>Fehlende Werte:<br>`NA`                                                             | Obere Grenze des punktweisen 95%-Konfidenzintervalls des GAM-Vorhersagewerts.                                                                                                                                                                                                           |
| untere_schranke        | number  | Werte:<br>`≥0`<br>Fehlende Werte:<br>`NA`                                                             | Untere Grenze des punktweisen 95%-Konfidenzintervalls des GAM-Vorhersagewerts.                                                                                                                                                                                                          |
| einwohner              | integer | Werte:<br>`≥0`<br>Fehlende Werte:<br>`NA`                                                             | Anzahl an Einwohnern, die an die Kläranlage angeschlossen sind.                                                                                                                                                                                                                         |
| laborwechsel           | string  | Werte:<br>`ja`, `nein`<br>Fehlende Werte:<br>`NA`                                                     | Gibt an, ob es Laborwechsel bzw. Änderungen in den Labormethoden gab.                                                                                                                                                                                                                   |
| typ                    | string  | Werte:<br>`SARS-CoV-2`, `Influenza A`, `Influenza B`, `Influenza A+B`, `RSV A`, `RSV B`, `RSV A+B`, … | Virustyp.                                                                                                                                                                                                                                                                               |
| unter_bg               | string  | Werte:<br>`ja`, `nein`<br>Fehlende Werte:<br>`NA`                                                     | Gibt an, ob mindestens die Hälfte der gemessenen Gene unterhalb der Bestimmungsgrenze liegen.                                                                                                                                                                                           |
...
| Variable               | Typ     | Ausprägungen                                                                                          | Beschreibung                                                                                                                                                                                                                                                                                                                                                                                                                  |
|:-----------------------|:--------|:------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| datum                  | date    | Format:<br>`YYYY-MM-DD`                                                                               | Datum des Mittwochs einer Woche. Die Daten der unterliegenden Einzelzeitreihen werden innerhalb des Zeitraums vom vorherigen Donnerstag bis zum angegebenen Mittwoch gemittelt.                                                                                                                                                                                                                                               |
| n                      | integer | Werte:<br>`≥0`<br>Fehlende Werte:<br>`NA`                                                             | Anzahl der Standorte, die mindestens einen Messwert im durch "datum" beschriebenen Zeitraum übermittelt haben.                                                                                                                                                                                                                                                                                                                |
| anteil_bev             | number  | Werte:<br>`≥0`<br>Fehlende Werte:<br>`NA`                                                             | Anteil der Gesamtbevölkerung in Deutschland, der an die übermittelnden Kläranlagen angeschlossen ist.                                                                                                                                                                                                                                                                                                                         |
| viruslast              | number  | Werte:<br>`≥0`<br>Fehlende Werte:<br>`NA`                                                             | Gemessene Viruslast (in Genkopien pro Liter), gemittelt über alle Standorte und gewichtet nach angeschlossenen Einwohnern der Kläranlagen. Vor der Mittelung über die Standorte wurden alle Messwerte der Standorte in den letzten 7 Tagen jeweils mittels 10er-Logarithmus transformiert und über die einzelnen Standorte gemittelt. Die angegebene Viruslast ist der auf die Originalskala zurücktransformierte Mittelwert. |
| viruslast_normalisiert | number  | Werte:<br>`≥0`<br>Fehlende Werte:<br>`NA`                                                             | Nach dem Durchfluss normalisierte Viruslast (wie in der Variable "viruslast" beschrieben).                                                                                                                                                                                                                                                                                                                                    |
| vorhersage             | number  | Werte:<br>`≥0`<br>Fehlende Werte:<br>`NA`                                                             | Vorhergesagte Viruslast (mittels einer GAM-Regression auf Basis der nicht-normalisierten Viruslasten, optimiert mittels Kreuzvalidierung-Kriterium für die logarithmierten Werte, angegeben ist der auf die Originalskala zurücktransformierte Wert).                                                                                                                                                                         |
| obere_schranke         | number  | Werte:<br>`≥0`                                                                                        | Obere Grenze des punktweisen 95%-Konfidenzintervalls des GAM-Vorhersagewerts.                                                                                                                                                                                                                                                                                                                                                 |
| untere_schranke        | number  | Werte:<br>`≥0`                                                                                        | Untere Grenze des punktweisen 95%-Konfidenzintervalls des GAM-Vorhersagewerts.                                                                                                                                                                                                                                                                                                                                                |
| typ                    | string  | Werte:<br>`SARS-CoV-2`, `Influenza A`, `Influenza B`, `Influenza A+B`, `RSV A`, `RSV B`, `RSV A+B`, … | Virustyp.                                                                                                                                                                                                                                                                                                                                                                                                                     |
