...
**Zitieren**  
Robert Koch-Institut, & Umweltbundesamt. (2026). Abwassersurveillance AMELAG [Data set]. Zenodo. [https://doi.org/10.5281/zenodo.18243610](https://doi.org/10.5281/zenodo.18243610)
...
| viruslast_normalisiert | number  | Werte: `≥0`<br>Fehlende Werte: `NA`                                                                | Nach dem Durchfluss normalisierte Viruslast (wie in der Variable "viruslast" beschrieben).                                                                                                                                                                                              |
| vorhersage             | number  | Werte: `≥0`<br>Fehlende Werte: `NA`                                                                | Vorhergesagte Viruslast (mittels einer GAM-Regression mit adaptiver Glättung auf Basis der nicht-normalisierten Viruslasten, optimiert mittels Kreuzvalidierung-Kriterium für die 10er-logarithmierten Viruslasten, angegeben ist der auf die Originalskala zurücktransformierte Wert). |
| obere_schranke         | number  | Werte: `≥0`<br>Fehlende Werte: `NA`                                                                | Obere Grenze des punktweisen 95%-Konfidenzintervalls des GAM-Vorhersagewerts.                                                                                                                                                                                                           |
| untere_schranke        | number  | Werte: `≥0`<br>Fehlende Werte: `NA`                                                                | Untere Grenze des punktweisen 95%-Konfidenzintervalls des GAM-Vorhersagewerts.                                                                                                                                                                                                          |
...
| viruslast_normalisiert | number  | Werte: `≥0`<br>Fehlende Werte: `NA`                                                                | Nach dem Durchfluss normalisierte Viruslast (wie in der Variable "viruslast" beschrieben).                                                                                                                                                                                                                                                                                                                                    |
| vorhersage             | number  | Werte: `≥0`<br>Fehlende Werte: `NA`                                                                | Vorhergesagte Viruslast (mittels einer GAM-Regression auf Basis der nicht-normalisierten Viruslasten, optimiert mittels Kreuzvalidierung-Kriterium für die logarithmierten Werte, angegeben ist der auf die Originalskala zurücktransformierte Wert).                                                                                                                                                                         |
