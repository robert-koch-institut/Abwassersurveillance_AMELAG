...
**Zitieren**  
Robert Koch-Institut, & Umweltbundesamt. (2025). Abwassersurveillance AMELAG [Data set]. Zenodo. [https://doi.org/10.5281/zenodo.17045957](https://doi.org/10.5281/zenodo.17045957)
...
| loess_vorhersage       | number  | Werte: `≥0`<br>Fehlende Werte: `NA`                                                                | Vorhergesagte Viruslast (mittels einer GAM-Regression mit adaptiver Glättung auf Basis der nicht-normalisierten Viruslasten, optimiert mittels Kreuzvalidierung-Kriterium für die 10er-logarithmierten Viruslasten). |
| loess_obere_schranke   | number  | Werte: `≥0`<br>Fehlende Werte: `NA`                                                                | Obere Grenze des punktweisen 95%-Konfidenzintervalls des GAM-Vorhersagewerts.                                                                                                     |
| loess_untere_schranke  | number  | Werte: `≥0`<br>Fehlende Werte: `NA`                                                                | Untere Grenze des punktweisen 95%-Konfidenzintervalls des GAM-Vorhersagewerts.                                                                                                    |
...
| viruslast_normalisiert | number  | Werte: `≥0`<br>Fehlende Werte: `NA`                                                                | Nach dem Durchfluss normalisierte Viruslast (wie in der Variable "viruslast" beschrieben).                                                                                                                                                                                                                                                                                                                                    |
| loess_vorhersage       | number  | Werte: `≥0`<br>Fehlende Werte: `NA`                                                                | Vorhergesagte Viruslast (mittels einer GAM-Regression auf Basis der nicht-normalisierten Viruslasten, zurücktransformiert auf die Originalskala).                                                                                                                                                                                                                                                                           |
| loess_obere_schranke   | number  | Werte: `≥0`                                                                                        | Obere Grenze des punktweisen 95%-Konfidenzintervalls des GAM-Vorhersagewerts.                                                                                                                                                                                                                                                                                                                                               |
| loess_untere_schranke  | number  | Werte: `≥0`                                                                                        | Untere Grenze des punktweisen 95%-Konfidenzintervalls des GAM-Vorhersagewerts.                                                                                                                                                                                                                                                                                                                                              |
| typ                    | string  | Werte: `SARS-CoV-2`, `Influenza A`, `Influenza B`, `Influenza A+B`, `RSV A`, `RSV B`, `RSV A+B`, … | Virustyp.                                                                                                                                                                                                                                                                                                                                                                                                                     |
