...
**Zitieren**  
Robert Koch-Institut, & Umweltbundesamt. (2025). Abwassersurveillance AMELAG [Data set]. Zenodo. [https://doi.org/10.5281/zenodo.16752527](https://doi.org/10.5281/zenodo.16752527)
...
| loess_vorhersage       | number  | Werte: `≥0`<br>Fehlende Werte: `NA`                                                                | Vorhergesagte Viruslast (mittels einer LOESS-Regression auf Basis der nicht-normalisierten Viruslasten, optimiert mittels AICc-Kriterium für die 10er-logarithmierten Viruslasten). |
...
| viruslast_normalisiert | number  | Werte: `≥0`<br>Fehlende Werte: `NA`                                                                | Nach dem Durchfluss normalisierte Viruslast (wie in der Variable "viruslast" beschrieben).                                                                                                                                                                                                                                                                                                                                    |
| loess_vorhersage       | number  | Werte: `≥0`<br>Fehlende Werte: `NA`                                                                | Vorhergesagte Viruslast (mittels einer LOESS-Regression auf Basis der nicht-normalisierten Viruslasten, zurücktransformiert auf die Originalskala).                                                                                                                                                                                                                                                                           |
...
**Cite**  
Robert Koch Institute, & Federal Environment Agency. (2025). Wastewater Surveillance AMELAG [Data set]. Zenodo. [https://doi.org/10.5281/zenodo.16752527](https://doi.org/10.5281/zenodo.16752527)
